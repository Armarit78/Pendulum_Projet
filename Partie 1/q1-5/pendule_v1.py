...
angle_plot(temps, sol, filename=os.path.join(repertoire_script_courant, 'angle_plot_1.png'))
angular_velocity_plot(temps, sol, filename=os.path.join(repertoire_script_courant, 'angular_velocity_plot_1.png'))
plot_trajectories(temps, sol, filename=os.path.join(repertoire_script_courant, 'trajectories_1.png'))

def save_animation_once(ani, filename='double_pendulum_2sec_1.mp4', fps=200):
...
energy_evolution_plot(temps, Ec_values, Ep_values, Et_values, filename=os.path.join(repertoire_script_courant, 'energy_evolution_1.png'))
